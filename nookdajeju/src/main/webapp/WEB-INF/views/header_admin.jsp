...
<header>
	<div class='header_inner'>
		<div class="header_logo">
			<a href="main.do"><img alt="로고" src='${path }/resources/img/logo.png' class="logo"></a>
		</div>
			...
			<ul class="nav_sub">
				...
				<c:if test="${not empty memail }">
					<li class="welcome"><img class="orange" alt="오렌지" src="${path }/resources/img/favicon.png" ><span class="nname">${sessionScope.nickname }</span><span class="wel">님 &nbsp; | &nbsp; </span></li>
						...
						<li class="page"><a href="adminMain.do"><img title="관리자페이지" alt="관리자페이지" src="${path }/resources/img/admin2.svg"></a></li>
				</c:if>
